...
public class Panneau extends JPanel implements ActionListener, KeyListener{ 
    ...
    public void paintComponent (Graphics g) {
    	super.paintComponent(g); 
    	 ...
    	 Color colors[] = { new Color(80, 90, 3), new Color(204, 102, 102), 
	...
	public void actionPerformed(ActionEvent e) { 
		 ...
		 if ( !limit(Pie,x, y)) {
			 ...
			 gest.copy(s, Pie,x, y);
			 s=gest.updat(s);
			Point.setText("Votre Score est: "+String.valueOf(gest.NumberPoint)+"                                         "+bestScore);
			 if(rnd<=6){
				 rnd=rnd+1;
				 System.out.print(" "+"\n");
			 }
		...
		if(s[0][0] == 1 ) {
        tm.stop();
        Point.setText("Veuillez démarrer une nouvelle partie !");
			}	
		else{
			repaint();
		}
